...
const SliderCard = ({ sliderImage }) => {
  return (
    <div className="flex items-center justify-center">
      <img
        className="w-full md:h-[90vh] brightness-[0.3]"
        src={sliderImage}
        alt=""
      />
      <div className="absolute z-30 w-1/2 text-white space-y-8">
        <h1 className=" text-6xl font-medium leading-tight">
          Get Ready to Excel <br /> in Your Online Learning <br /> Today with {""}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-indigo-400 animate-pulse">
            LEARNING CAMP
          </span>
        </h1>
        <p className="text-xl">
